...
const initQuill = (containerID) =>  {
  new Quill(`#${containerID}`, {  
    modules: {
                          ...
                          <select class="form-select" aria-label="Default select example">
                            ...
                            <div class="row px-4 gap-2">
                              <div class="col-md-2 mb-3">
                                <div class="form-outline mb-4">
                                  <label class="form-label fw-normal color-negro">Texto</label>
                                  <input type="text" class="form-control border-0  form-control-lg fs-6 fw-normal" placeholder="Texto" disabled/>
  </div>
</div>
<div class="col-md-2 mb-3">
  <div class="form-outline mb-4">
    <label class="form-label fw-normal  color-negro" for="typeEmailX-2 ">Tipo de promoción</label>
    <input type="text" class="form-control border-0 fondo-gris form-control-lg fs-6 fw-normal" placeholder="Tipo de promoción" disabled/>
  </div>
</div>
<div class="col-md-2 mb-3">
  <div class="form-outline mb-4">
...
<div class="col-md-2 mb-3">
  <div class="form-outline mb-4">
    <label class="form-label fw-normal  color-negro" for="typeEmailX-2 ">Tipo de promoción</label>
    <input type="text"  class="form-control border-0 form-control-lg fs-6 fw-normal" placeholder="Tipo de promoción" disabled/>
  </div>
</div>
<div class="col-md-3 mb-3">
  <div class="form-outline mb-4">
    <label class="form-label fw-normal  color-negro" for="typeEmailX-2 ">Incidentes</label>
    <input type="text" class="form-control border-0 form-control-lg fs-6 fw-normal" placeholder="Incidentes" disabled/>
  </div>
</div>
</div>
...
<div class="mt-2">
  <br>
  <button class="btn px-4 fs-6  text-left fondo-verde boton-verde sombra1">
...
<div id="editorTexto">
  ...
  `;
  divContent.removeClass("mt-5 text-center").html(html);
  initQuill('editorTexto','container');
  // const getInfo = await requestAxios('GET', 'urlapizifris', {});
  // if(getInfo.code === 200) {
  //     console.log('Todo verde');
  // } else {
...
const renderBitacora = async (divContent) => {
  ...
  <div class="bg-white">
    <div id="seccionAudiencias">
            ...
            <ul class="nav nav-pills mt-3 justify-content-end">
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" >Audiencias</a></li>
                  <li><a class="dropdown-item" onclick="showDetalle('seccionTerminos', 'seccionAudiencias')">Términos</a></li>
                  <li><a class="dropdown-item" onclick="showDetalle('seccionPendientes', 'seccionAudiencias')">Pendientes</a></li>
                  ...
                  <li class="nav-item dropdown">
                    <a class="nav-link  nav-verde dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="#">Mensajería</a></li>
                        </ul>
                        </li>
                        <li class="nav-item" role="presentation">
                                        ...
                                        <tbody>
                                          <tr>
                                            ...
                                            <tr>
                                              ...
                                              <tr>
                                                <td class="py-3">Aluguesa</td>
                                                <td class="py-3"><span data-bs-toggle="miTooltip" data-bs-placement="top"
                                                data-bs-title="This top tooltip is themed via CSS variables.">GDL</span></td>
                                                <td class="py-3">Junta Especial #15</td>
                                                <td class="py-3">20/11/2021</td>
                                                <td class="py-3">1:00 pm</td>
                                                <td class="py-3">Desahogo de pruebas</td>
      ...
      <!--Sección Términos-->
    <div class="d-none" id="seccionTerminos">                                               
      <!--Seccion Terminos-->
      <div class="row px-5 pt-5">
        <div class="col-6">
          <h2>Términos</h2>
        ...
        <div class="col-6 text-end">
          <ul class="nav nav-pills mt-3 justify-content-end" id="pills-tab">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item"   onclick="showDetalle('seccionAudiencias', 'seccionTerminos')">Audiencias</a></li>
                  <li><a class="dropdown-item" onclick="showDetalle('seccionPendientes', 'seccionTerminos')">Términos</a></li>
                  <li><a class="dropdown-item" onclick="showDetalle('seccionPendientes', 'seccionTerminos')">Pendientes</a></li>
                  <li><a class="dropdown-item" >Todos</a></li>
              </ul>
            </li>
            <li class="nav-item dropdown">
        ...
        <hr class="mb-5">
        <div class="table-responsive py-4" id="pills-terminos">
          <table class="table text-center textos mt-4 mb-4">
            <thead>
              <tr>
                <th style="min-width:200px; ">Cliente</th>
                <th style="min-width:200px; ">Expediente</th>
                <th style="min-width:200px; ">Tipo de termino</th>
                <th style="min-width:200px; ">Elabora</th>
                <th style="min-width:300px; ">Supervisa</th>
                <th style="min-width:200px; ">Fecha de vencimiento</th>
                <th style="min-width:200px; ">Fecha de carga</th>
                <th style="min-width:200px; ">Fecha de autorización</th>
                <th style="min-width:200px; ">Fecha de presentación</th> 
                <th style="min-width:200px; ">Observaciones / Notas</th>
                <th style="min-width:200px; ">Estatus</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td class="py-3">Aluguesa</td>
                <td class="py-3">2552/2016/15-A</td>
                <td class="py-3">Termino 1</td>
                <td class="py-3 color-gris2">Asignado</td>
                <td class="py-3">Gomez Tapia Angel Alberto</td>
                <td class="py-3">2019-10-15</td>
                <td class="py-3">2019-10-15</td>
                <td class="py-3">2019-10-15</td>
                <td class="py-3">2019-10-15</td>
                <td class="py-3"></td>
                <td class="py-3">Elaborando</td>
                </tr>
                <tr>
                  <td class="py-3">Aluguesa</td>
                  <td class="py-3">2552/2016/15-A</td>
        ...
        <!--Seccion Pendientes-->
        <div class="d-none" id="seccionPendientes">
        <div class="row px-5 pt-5">
          <div class="col-6">
            <h2>Pendientes</h2>
          </div>
          <div class="col-6 text-end">
            <ul class="nav nav-pills mt-3 justify-content-end" id="pills-tab">
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item"   onclick="showDetalle('seccionAudiencias', 'seccionPendientes')">Audiencias</a></li>
                    <li><a class="dropdown-item" onclick="showDetalle('seccionTerminos', 'seccionPendientes')">Términos</a></li>
                    <li><a class="dropdown-item" onclick="showDetalle('seccionPendientes', 'seccionTerminos')">Pendientes</a></li>
          ...
          <div class="table-responsive py-4">
            <table class="table text-center textos mt-4 mb-4">
              <thead>
                <tr>
                  <th style="min-width:200px; ">Total</th>
                  <th style="min-width:200px; ">En curso</th>
                  <th style="min-width:200px; ">Cancelados</th>
                  <th style="min-width:200px; ">Atendidos</th>
                  <th style="min-width:300px; ">No atendidos</th>
                  <th style="min-width:200px; ">Terminados</th>
                  <th style="min-width:200px; ">Prorrogados</th>
                  <th style="min-width:200px; ">Por atender</th>
                  <th style="min-width:200px; ">Observaciones / Notas</th>
                </tr>
              </thead>
              <tbody>
                    ...
                    <td class="py-3">Elaborando</td>
                                                ...
                                                <div class="modal textos fade" id="agregarTarea" tabindex="-1" aria-hidden="true">
                                                  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
                                                    <div class="modal-content">
                                                      <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Agregar audiencia</h1>
